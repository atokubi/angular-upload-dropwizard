 ...
 *
 * `ngCloak` works in cooperation with a css rule that is embedded within `js` and
 ...
 *
 * For the best result, `js` script must be loaded in the head section of the html file;
 ...
 * These rules are bundled with js and the rules can be overridden
